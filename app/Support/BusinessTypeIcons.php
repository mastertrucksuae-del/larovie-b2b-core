...
/**
 * The icon set offered for a business type chip.
 *
 * A fixed list rather than free-text: these render as inline SVG on a public
 * page, so letting an admin paste arbitrary markup would be an XSS hole. Each
 * entry is a Heroicons v2 outline path, matching the icons used everywhere else
 * on the storefront.
 */
class BusinessTypeIcons
{
    public const DEFAULT = 'storefront';

    /**
     * key => [label, svg path data]
     *
    ...
    public const ICONS = [
        ...
        'truck' => [
            'label' => 'Distributor (truck)',
            'path' => 'M8.25 18.75a1.5 1.5 0 0 1-3 0m3 0a1.5 1.5 0 0 0-3 0m3 0h6m-9 0H3.375a1.125 1.125 0 0 1-1.125-1.125V14.25m17.25 4.5a1.5 1.5 0 0 1-3 0m3 0a1.5 1.5 0 0 0-3 0m3 0h1.125c.621 0 1.129-.504 1.09-1.124a17.902 17.902 0 0 0-3.213-9.193 2.056 2.056 0 0 0-1.58-.86H14.25M16.5 18.75h-6',
        ],
        'office' => [
        ...
        'hotel' => [
            ...
            'path' => 'M2.25 21h19.5m-18-18v18m10.5-18v18m6-13.5V21M6.75 6.75h.75m-.75 3h.75m-.75 3h.75m3-6h.75m-.75 3h.75m-.75 3h.75M6.75 21v-3.375c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21M3 3h12M14.25 7.5h5.25a.75.75 0 0 1 .75.75V21',
        ],
        'beaker' => [
    ...
    /** Options for a Filament select: key => label. @return array<string, string> */
    public static function options(): array
    {
        return array_map(fn (array $icon) => $icon['label'], self::ICONS);
    }

    /** The path data for a key, falling back to the default rather than blank. */
    public static function path(?string $key): string
    {
        return self::ICONS[$key]['path'] ?? self::ICONS[self::DEFAULT]['path'];
    }
}
